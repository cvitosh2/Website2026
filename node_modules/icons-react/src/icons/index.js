...
module.exports = {
  icons: [
    ...
    },
    {
      ...
      contents: [
        {
          files: path.resolve(__dirname, "line-awesome/src/production/*.svg"),
    ...
    },
    {
      ...
      contents: [
        ...
        },
        {
          ...
          formatter: name => `Ci${name}Color`,
          multiColor: true
        },
        // {
        //   files: path.resolve(__dirname, "cryptocurrency-icons/svg/icon/*.svg"),
        //   formatter: name => `Ci${name}Icon`,
        //   multiColor: true
        // }
      ],
      projectUrl: "https://github.com/atomiclabs/cryptocurrency-icons",
      license: "CC BY 1.0 License",
