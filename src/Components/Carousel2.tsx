...
const imageModules = import.meta.glob("../assets/pics/*.{jpg,JPG,jpeg,png,webp,bmp,avif}", {
    eager: true,
    import: "default",
}) as Record<string, string>

const Images = {
    JA: imageModules["../assets/pics/JA.JPG"],
    JoeAnnieHouse: imageModules["../assets/pics/JoeAnnieHouse.jpg"],
    StupnoSnow: imageModules["../assets/pics/StupnoSnow.jpg"],
    Johnanna: imageModules["../assets/pics/Johnanna.jpg"],
    BEZDEK: imageModules["../assets/pics/BEZDEK.JPG"],
    image004: imageModules["../assets/pics/image004.jpg"],
    JamesHelen: imageModules["../assets/pics/JamesHelen.jpg"],
...
const DEFAULT_IMAGES: CoverflowImage[] = ImageURLs.map((url, i) => ({
    srcUrl: url,
